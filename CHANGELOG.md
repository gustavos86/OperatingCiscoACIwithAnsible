...
- tags to MSO roles
- deploy VRFs to MSO
- deploy Bridge Domains to MSO
- deploy Application Profiles to MSO
- deploy EPGs to MSO
- associate Domain to EPG in MSO

## [v0.32] - 2021-06-15

### Added

- first MSO modules (very limited deployment)
...
- skip adding attaching domain and static bindings to EPGs with epg_state == 'absent' to avoid errors
- modified strategy to deploy Storage Domains and EPG Storage static bindings

## [v0.29] - 2021-06-13

### Added

- role: Interface_Selectors now also adds description to ports
- documentation to Switch_and_Interface_Profiles, Interface_Selectors and enable_or_disable_ports
- more documentation in the file host_vars

### Changed

- moved role: enable_or_disable_ports out of allFabricAccess tag.
- role: enable_or_disable_ports must be explicitly called with 'ansible-playbook aci_playbook.yaml -i inventory --tags shutdownports'
- added prompt to confirm action when running the role enable_or_disable_ports
